...
const Body = () => {
  ...
  return listOfRestaurants.length == 0 ? (
    ...
    <div className="body">
      <div className="flex filter m-2 p-2 flex-col sm:md:flex-row justify-between px-5 md:px-10">
        <h1 className="px-2 py-2 sm:md:px-5 font-bold text-2xl md:text-5xl">Restaurant List</h1>
        <div>
          <button
